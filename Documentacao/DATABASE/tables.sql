...
ALTER TABLE  "TB_EMPRESA" ADD CONSTRAINT "TB_EmpresaTerceira_FK_RAMO" FOREIGN KEY ("RAMO")
    REFERENCES  "TB_RAMO" ("ID_RAMO") ENABLE;

ALTER TABLE "TB_FUNCIONARIOS" DROP CONSTRAINT "TB_FUNCIONARIOS_FK_EmpresaTerceira";
